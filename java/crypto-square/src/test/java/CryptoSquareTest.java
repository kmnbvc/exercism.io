...
public class CryptoSquareTest {
    ...
    public void normalizedCipherIsSplitIntoSegmentsOfCorrectSize() {
        ...
        String s0 = "imtgdvsfearwermayoogoanouuiontnnlvtwttddesaohghnsseoau";
        String s1 = "imtgdvs fearwermayoogoanouuiontnnlvtwttddesaohghnsseoau";
        String s2 = "imtgdvs fearwer mayoogoanouuiontnnlvtwttddesaohghnsseoau";
        String s3 = "imtgdvs fearwer mayoogo anouuiontnnlvtwttddesaohghnsseoau";
        String s4 = "imtgdvs fearwer mayoogo anouuio ntnnlvtwttddesaohghnsseoau";
        String s5 = "imtgdvs fearwer mayoogo anouuio ntnnlvt wttddesaohghnsseoau";
        String s6 = "imtgdvs fearwer mayoogo anouuio ntnnlvt wttddes aohghnsseoau";
        String s7 = "imtgdvs fearwer mayoogo anouuio ntnnlvt wttddes aohghn sseoau";
